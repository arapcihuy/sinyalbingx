...
signal_data = {
    ...
    "price": entry_price,
    "sl": 59000.0,
    "tp1": 61000.0, "tp1_qty": 0.5,
    "tp2": 62000.0, "tp2_qty": 0.5
}
...
print(f"   Harga sekarang: {current_mock_price}. Belum kena TP1 (61000).")

print("\n---------------------------------------------------------")
print(f"⏱️ [DETIK 10] BINGO! Harga tembus TP1 (61200) 🎯")
